...
// import { handleDefenderInstall } from './commands/functions/handleDefenderInstall';
...
//         vscode.commands.registerCommand('extension.install-defender', () => handleDefenderInstall(context))
//     );
// }
